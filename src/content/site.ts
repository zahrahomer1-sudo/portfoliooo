...
export const about = {
  ...
  body: [
    ...
    "The through-line is authorship — deciding what a thing is before deciding what it looks like, and holding that through every frame.",
  ],
} as const;
...
export const album = {
  ...
  /**
   * Background film for the album. Drop real footage at either path; without
   * one the section falls back to the first frame's still, so it never looks
   * broken.
   */
  video: "/media/album.webm",
  videoMp4: "/media/album.mp4",
  /**
   * TODO: point this at the full album once one exists. For now it goes
